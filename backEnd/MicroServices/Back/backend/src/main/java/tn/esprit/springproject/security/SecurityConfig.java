...
import tn.esprit.springproject.Services.UserService;
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
      http
              ...
              .authorizeHttpRequests(req -> req
                      ...
                      // Shared resource endpoints for ADMIN and MANAGER
                      .requestMatchers("/resource/**").hasAnyRole("ADMIN", "MANAGER", "CLIENT")
...
//zidekt client :.requestMatchers("/resource/**").hasAnyRole("ADMIN", "MANAGER", "CLIENT")