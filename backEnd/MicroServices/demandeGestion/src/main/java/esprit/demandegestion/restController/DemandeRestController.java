...
import esprit.demandegestion.services.EmailService;
...
public class DemandeRestController {
    ...
    private final EmailService emailService; // <-- ajouter ceci

    @Autowired
    public DemandeRestController(DemandeService demandeService,
                                 DemandeRepository demandeRepository,
                                 EmailService emailService) { // <-- et ici
        this.demandeService = demandeService;
        this.demandeRepository = demandeRepository;
        this.emailService = emailService; // <-- et ici
    }
    ...
    public ResponseEntity<Demande> createDemande(@Valid @RequestBody Demande demande) {
        ...
        // Appeler le service d’envoi d’email après création
        emailService.sendDemandeNotificationToAdmin(createdDemande);
